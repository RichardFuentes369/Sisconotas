			...
			<div class="row">
				<div class="col-sm-12">
					<div class="row">
						...
						<div class="col-sm-8">
							<input type="text" readonly class="form-control static" id="name" value="{{ $existe->name }}"><br>
						</div>
					</div>
				</div>
				<div class="col-sm-12">
					<div class="row">
						...
						<div class="col-sm-8">
							<input type="text" readonly class="form-control static" id="lastname" value="{{ $existe->lastname }}"><br>
						</div>
					</div>
				</div>
				<div class="col-sm-12">
					<div class="row">
						...
						<div class="col-sm-8">
							<input type="text" readonly class="form-control static" id="email" value="{{ $existe->email }}"><br>
						</div>
					</div>
				</div>
				<div class="col-sm-12">
					<div class="row">
						...
						<div class="col-sm-8">
							<input type="text" readonly class="form-control static" id="birthdate" value="{{ $existe->birthdate }}"><br>
						</div>
					</div>
				</div>
				<div class="col-sm-12">
					<div class="row">
						...
						<div class="col-sm-8">
							<input type="text" readonly class="form-control static" id="sexo" value="{{ $existe->sexo }}"><br>
						</div>
					</div>
				</div>
				<div class="col-sm-12">
					<div class="row">
						...
						<div class="col-sm-8">
							<input type="text" readonly class="form-control static" id="phone" value="{{ $existe->phone }}"><br>
						</div>
					</div>
				</div>
				<div class="col-sm-12">
					<div class="row">
						...
						<div class="col-sm-8">
							<input type="text" readonly class="form-control static" id="cellphone" value="{{ $existe->cellphone }}"><br>
						</div>
					</div>
				</div>
			</div>			
